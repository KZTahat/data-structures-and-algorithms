...
const containsAnd = (arr) => {
  // Solution code here...
  let newStringArray = arr.filter(element => {
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let flag;
  let values = arr.filter(element => {
    flag = forbiddenValues.includes(element);
    if (flag == false) {
      return element;
    }
  })
...
// notInFirstArray(['Demi', 'Gregor', 'Hound'], ['Gary', 'Charlotte', 'Demi', 'Gregor', 'Hound'])
// notInFirstArray([1, 2, 6], [4, 5, 6, 7]);
// notInFirstArray([], [])
// notInFirstArray([], [1,2,3,4,5])
// notInFirstArray([1,2,3,4,5], [])
/* ------------------------------------------------------------------------------------------------
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let testingArray = [];
  let statName = arr.filter(element => {
    if (element.baseStat > minBaseStat) {
      let name = element.stat.name;
      testingArray.push(name);
      return testingArray;
    }
  })
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let charsWithoutChilds = arr.filter(element => {
    if (!element.hasOwnProperty('children')) {
      return element;
    }
  })
  return charsWithoutChilds;
};
/* ------------------------------------------------------------------------------------------------
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let numericValues = arr.filter(element => {
    if (typeof element === 'number') { return element }
  })
  let evenAndOddValues = numericValues.map(element => {
    if (element % 2 == 0) {
      return 'even';
    } else if (element % 2 !== 0) {
      return 'odd';
