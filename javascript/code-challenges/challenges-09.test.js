...
const updateNumbers = (obj) => {
  ...
  keys.forEach((element, inedx) => {
    entries.push(`${element}: ` + values[inedx]);
  });
  console.log(entries);
  return entries;
};
...
const hasChildrenValues = (arr, character) => {
  ...
  let flag = false;
  arr.forEach((element) => {
    if ((element.name == character) && (element.hasOwnProperty('children'))) {      
      flag = true;
    }
  });
  if (flag == true) {
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(element => {
    ...
    if (element.hasOwnProperty('children')) {
      total = total + element.children.length;
    }
  })
  console.log(total);
  return total;
...
const houseSize = (arr) => {
  ...
  // Solution code here...
  arr.forEach(element => {
    let members = Object.values(element).length;
    if (element.hasOwnProperty('children')) {
      members = members + element.children.length -1;
    }
    // console.log(members);
    sizes.push({house: element.house, members: members-1})
  })
  return sizes;
};
/* ------------------------------------------------------------------------------------------------
