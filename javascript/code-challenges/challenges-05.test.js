...
const addValues = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((accumulator,cuurentValue) => {
...
const returnNames = (arr) => {
  ...
  arr.reduce((accumulator,currentValue) => {
    charNames.push(currentValue.name);
  }, 0)
  return charNames;
};
/* ------------------------------------------------------------------------------------------------
...
const reversedString = (str) => {
  ...
  let reversed = splitted.reduce((accumulator,currentValue) => {
...
const countNumberOfChildren = (arr) => {
  ...
  arr.reduce((accumulator,currentValue) => {
    ...
    if (currentValue.hasOwnProperty('children')) {
      return currentValue.children.map(element => {
        total = total + 1;
      })
    }
  }, 0)
...
const extractChildren = (arr) => {
  // Solution code here...
  let containAchar = arr.filter(element => {
    if (element.name.includes('a')) {
      return element;
    }
  })
  let childerNames = [];
  containAchar.reduce((accumulator,currentValue) => {
    if (currentValue.hasOwnProperty('children')) {
      currentValue.children.map(element => {
        childerNames.push(element);
      })
    }
  }, 0)
  return childerNames;
