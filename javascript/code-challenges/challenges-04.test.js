...
const sortByPrice = (arr) => {
  ...
  arr.sort((a,b) => {
    const first = a.price;
    const seconed = b.price;
    if (first >seconed) {
      return 1;
    } else if(seconed > first){
      return -1;
    }else return 0;
  })
  return arr;
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  arr.sort((a,b) => {
    let first = a.toString().length;
    let seconed = b.toString().length;
    if (first >seconed) {
      return 1;
    } else if(seconed > first){
      return -1;
...
const sortPeopleBetter = (arr) => {
  ...
  arr.sort((a,b) => {
    if (a.lastName > b.lastName) {
      ...
      let first1 = a.firstName;
      let first2 = b.firstName;
      if (first1 >first2) {
        return 1;
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a,b) => {
    ...
    return daysOrder[day1] - daysOrder[day2];
  })
  return arr;
};
/* ------------------------------------------------------------------------------------------------
...
const sortSchedule = (arr) => {
  ...
  arr.sort((a,b) => {
    ...
    if (daysOrder[day1] > daysOrder[day2]) {
      return 1;
    } else if(daysOrder[day1] < daysOrder[day2]){
      return -1;
    }else{
