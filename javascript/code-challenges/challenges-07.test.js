...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  starWarsArr.sort((a, b) => b.age - a.age);
...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  let x = recipe.ingredients[0].slice(-8, recipe.ingredients[0].length);
  console.log(x);
  return result;
};
...
const removeEvenValues = (arr, invert = false) => {
  // Solution code here...
...
const removeLastCharacters = (str, numberOfCharacters) => {
  ...
  let splitted = str.split('');
  let joined 
  if (numberOfCharacters > splitted.length ) {
    return "";
...
// removeLastCharacters("Gregor", 12)
/* ------------------------------------------------------------------------------------------------
...
const extractVowels = (str) => {
  ...
  for (let i = 0; i < splitted.length; i++) {
    ...
    if(x == "a" || x == "e" || x == "i" || x == "o" || x == "u" ) {
      ...
      let extracted = splitted.splice(i,1);
    }
  }
  let array2 = newArray.join('');
